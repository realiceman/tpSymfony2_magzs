...
use Youss\MagazineBundle\Entity\Issue;
use Youss\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('YoussMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("YoussMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('YoussMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("YoussMagazineBundle:Issue:edit.html.twig")
     */
