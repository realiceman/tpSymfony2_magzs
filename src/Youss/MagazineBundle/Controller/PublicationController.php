...
namespace Youss\MagazineBundle\Controller;
...
use Youss\MagazineBundle\Entity\Publication;
use Youss\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('YoussMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("YoussMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('YoussMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("YoussMagazineBundle:Publication:edit.html.twig")
     */
